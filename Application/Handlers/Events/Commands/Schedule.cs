...
namespace Application.Handlers.Events.Commands
{
    ...
    {
        /// <summary>
        /// Command class used to start the request for scheduling a new Event.
        /// </summary>
        ...
        /// <summary>
        /// Handler class used to handle the scheduling of the new Event.
        /// </summary>
        public class Handler : IRequestHandler<Command, Result<Unit>?>
        {
            ...
            /// <summary>
            /// Scheduling logic handled.
            /// </summary>
            /// <param name="request">IRequest object, i.e. Schedule.Command</param>
            ...
            public async Task<Result<Unit>?> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                @event.AddDomainEvent(new ScheduledEvent(@event));

                bool result = await _context.SaveChangesAsync(cancellationToken) > 0;

                if (!result)
                    return Result<Unit>.Failure("Failed to schedule a new Event.");
