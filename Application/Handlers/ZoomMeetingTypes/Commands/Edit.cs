...
namespace Application.Handlers.ZoomMeetingTypes.Commands
{
    ...
    {
        /// <summary>
        /// Command class used to start the request for editing a ZoomMeetingType.
        /// </summary>
        ...
        /// <summary>
        /// Handler class used to handle the editing of the ZoomMeetingType.
        /// </summary>
        public class Handler : IRequestHandler<Command, Result<Unit>?>
        {
            ...
            public async Task<Result<Unit>?> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                _mapper.Map(request.ZoomMeetingType, zoomMeetingType);

                bool result = await _context.SaveChangesAsync(cancellationToken) > 0;

                if (!result)
                    return Result<Unit>.Failure("Failed to update a ZoomMeetingType.");
        ...
        public class Validator : AbstractValidator<Command>
        {
            public Validator()
            {
                RuleFor(x => x.ZoomMeetingType).SetValidator(new ZoomMeetingTypeCommandDtoValidator());
            }
        }
    }
}
