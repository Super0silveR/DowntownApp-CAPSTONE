...
{
    /// <summary>
    /// ChatRoomTypeDto Validation Class.
    /// </summary>
    public class ChatRoomTypeCommandDtoValidator : AbstractValidator<ChatRoomTypeCommandDto>
    {
        /// <summary>
        /// Constructor initialize the validation rules.
        /// </summary>
        public ChatRoomTypeCommandDtoValidator()
        {
            RuleFor(ec => ec.Name)
                .MaximumLength(25)
                .MinimumLength(5)
